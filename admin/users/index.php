...
<?php include __DIR__ . '/../../app/include/header-admin.php'; ?>

<div class="container">

    <?php include __DIR__ . '/../../app/include/sidebar-admin.php' ?>
        ...
        <div class="posts col-9">
            ...
            <div class="row post">
                ...
                <?php if(mb_strlen($user['email']) > 10): ?>
                <div class="col-3"><?=substr($user['email'], 0, 10) . " ..." ?></div>
                <?php else: ?>
                <div class="col-3"><?=$user['email']?></div>
                <?php endif; ?>
                <?php if($user['admin']): ?>
                    <div class="col-2"><a href="edit.php?admin=0&user_id=<?=$user['id']; ?>">Admin</a></div>
                <?php else: ?>
                        <div class="col-2"><a href="edit.php?admin=1&user_id=<?=$user['id']; ?>">User </a></div>
                <?php endif; ?>
