<?php session_start();
    ...
    $userData = selectOne('user', ['id' => $_GET['id']]);
        ...
        <div class="row add-post">
            ...
            <form action="edit.php" method="post">
                ...
                <div class="col">
                    ...
                    <input name="login" value="<?=$userData['username']; ?>" type="text" class="form-control" id="formGroupExampleInput" placeholder="введите ваш логин...">
                </div>
                <div class="col">
                    <label for="exampleInputEmail1" class="form-label">Email</label>
                    <input name="mail" value="<?=$userData['email']; ?>" type="email" class="form-control" readonly id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="введите ваш email...">
                </div>
                <div class="col">
