            ...
            <div class="row add-post">
                ...
                <form action="create.php" method="post">
                    <div class="col">
                        ...
                        <input name="user-name" value="<?=$regData['username'] ?>" type="text" class="form-control" id="formGroupExampleInput" placeholder="введите ваш логин...">
                    </div>
                    <div class="col">
                        <label for="exampleInputEmail1" class="form-label">Email</label>
                        <input name="mail" value="<?=$regData['email'] ?>" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="введите ваш email...">
                    </div>
                    <div class="col">
