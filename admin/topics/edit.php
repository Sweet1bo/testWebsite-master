...
<div class="container">
    ...
    <div class="posts col-9">
        <div class="button row">
            ...
            <a href="<?php echo BASE_URL . "admin/topics/create.php" ?>" class="col-3 btn btn-warning">Редактировать</a>
        </div>
        ...
        <div class="row add-post">
            ...
            <form action="edit.php" method="post">
                ...
                <div class="col">
                    <input name="topic_name" value="<?=$topic['topic_name']; ?>" type="text" class="form-control" placeholder="Имя категории" aria-label="Имя категории">
                </div>
                <div class="col">
